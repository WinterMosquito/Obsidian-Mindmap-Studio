...
describe('wikilinkTargetIsAttachment', () => {
	it.each([
		...
		{ input: '画布.canvas', expected: false, why: 'Canvas 是官方文档类文件（可作双链目标）' },
		{ input: 'folder/看板.base', expected: false, why: 'Bases 是官方文档类文件' },
		{ input: '看板.BASE#View', expected: false, why: '大小写不敏感 + 区块剥离后仍是 base' },
