...
**产物字节级身份**：`vendor/simple-mind-map.cjs` 的 sha256（**按 LF 归一后**计算）=
`dca4ceadeea46ad003ad600aacecc328b388f3505855c83d63b4b12a300ac898`（406,580 B），
...
> 跨平台不同**。实测：本地原始字节哈希 = `a97b0caa…`（CRLF，96 处），
> CI = `dca4cead…`（LF，即上值）。故断言若不归一，必然**本地绿、CI 红**。
