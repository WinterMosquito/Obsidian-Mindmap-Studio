...
import { preMeasureCustomContents } from './src/core/render/preMeasure'
...
// 自有补丁（2026-09-25 性能轮，补丁 5）：首帧前批量预测量自绘内容尺寸——
// 生产由 engine/mindmap.ts 在 `new MindMap` 之后、首帧前调用。
MindMap.preMeasureCustomContents = preMeasureCustomContents
